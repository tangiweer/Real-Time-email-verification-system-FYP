...
- **Deep SMTP Diagnostics**: Performs deep SMTP – high-confidence results without sending email, using an SMTP handshake where the mail server accepts the recipient (no message sent) to confirm mailbox existence.
